...
// Mismo criterio que CarruselFotosEmprendedor.tsx/CarruselFotos.tsx
// (scroll-snap nativo, sin librería externa), sin recortar la foto
// (object-contain dentro de un marco de alto fijo). Doble clic/doble toque
// sobre una foto abre un visor a pantalla completa que también permite
// deslizar entre las fotos restantes.
export function CarruselFotosPublicacion({ fotos, alt }: { fotos: string[]; alt: string }) {
